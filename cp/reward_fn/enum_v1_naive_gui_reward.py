...
try:
    ...
    from cp.reward_fn.reward import point_enum_v1_naive as point_enum_reward
...
def enum_v1_naive_gui_reward_function(data_source, solution_str, ground_truth, extra_info=None, **kwargs):
    """
