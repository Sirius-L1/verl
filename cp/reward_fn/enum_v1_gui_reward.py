...
try:
    ...
    from cp.reward_fn.reward import point_enum_v1 as point_enum_reward
...
def enum_v1_gui_reward_function(data_source, solution_str, ground_truth, extra_info=None, **kwargs):
    """
