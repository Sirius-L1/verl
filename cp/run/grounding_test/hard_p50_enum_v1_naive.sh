...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test/hard_p50_enum_v1_naive/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test/hard_p50_enum_v1_naive/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=/lustre/projects/polyullm/yuhang/r2/verl/cp/reward_fn/enum_v1_naive_gui_reward.py \
    custom_reward_function.name=enum_v1_naive_gui_reward_function \
    ...
    trainer.experiment_name='hard_p50_enum_v1_naive' \
