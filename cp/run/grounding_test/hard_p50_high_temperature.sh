...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test/hard_p50_high_temperature/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test/hard_p50_high_temperature/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='hard_p50_high_temperature' \
