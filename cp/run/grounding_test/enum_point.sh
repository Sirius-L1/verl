...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test/enum_point/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test/enum_point/log-%j.err
# set -x
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='enum_point' \
