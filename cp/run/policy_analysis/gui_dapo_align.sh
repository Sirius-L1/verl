...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/logs/policy_analysis/gui_dapo_align-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/logs/policy_analysis/gui_dapo_align-%j.err
