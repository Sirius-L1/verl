...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder-v1/enum_v2_rloo_bs128_n16_uitars/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder-v1/enum_v2_rloo_bs128_n16_uitars/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/lustre/projects/polyullm/models/UI-TARS-1.5-7B \
    ...
    trainer.experiment_name='enum_v2_rloo_bs128_n16_uitars' \
