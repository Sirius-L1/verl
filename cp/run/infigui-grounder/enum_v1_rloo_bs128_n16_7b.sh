...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder/enum_v1_rloo_bs128_n16_7b/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder/enum_v1_rloo_bs128_n16_7b/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='enum_v1_rloo_bs128_n16_7b' \
