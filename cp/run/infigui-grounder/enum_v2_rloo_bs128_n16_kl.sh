...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder/enum_v2_rloo_bs128_n16_kl/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder/enum_v2_rloo_bs128_n16_kl/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='enum_v2_rloo_bs128_n16_kl' \
