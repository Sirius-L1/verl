...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder/enum_v2_rloo_bs8_n8/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/infigui-grounder/enum_v2_rloo_bs8_n8/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='enum_v2_rloo_bs8_n8' \
