...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test_1/enum_v2_rloo_bs128_n16/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test_1/enum_v2_rloo_bs128_n16/log-%j.err
