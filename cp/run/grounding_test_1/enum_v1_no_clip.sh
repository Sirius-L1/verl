...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test_1/enum_v1_no_clip/log-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/checkpoints/grounding_test_1/enum_v1_no_clip/log-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/lustre/projects/polyullm/yuhang/r2/data/train/ui_24k_0614_r1_grounding_point_enum.parquet \
    ...
    trainer.experiment_name='enum_v1_no_clip' \
