...
#SBATCH --output=/lustre/projects/polyullm/yuhang/r2/logs/on-policy_baseline/grpo_bsz64-%j.out
#SBATCH --error=/lustre/projects/polyullm/yuhang/r2/logs/on-policy_baseline/grpo_bsz64-%j.err
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='grpo_bsz64' \
