...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path=/lustre/projects/polyullm/yuhang/r2/verl/cp/reward_fn/mix_test_reward.py \
    custom_reward_function.name=mix_test_reward_function \
    ...
    trainer.project_name='verl_gui_test' \
    trainer.experiment_name='gui_3b_test' \
